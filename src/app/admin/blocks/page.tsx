...
export default function AdminBlocksPage() {
  const [list, setList] = useState<Block[]>(initBlocks);
  ...
  function handleAdd(e: React.FormEvent<HTMLFormElement>) {
    ...
    setShowForm(false);
    setTimeout(() => showToast(`เพิ่ม "${title}" แล้ว`, "added"), 80);
  }
  ...
  function handleEditSave(e: React.FormEvent<HTMLFormElement>) {
    ...
    setModal(null);
    setTimeout(() => showToast(`บันทึก "${updated.title}" แล้ว`, "added"), 100);
  }
  ...
  function confirmDelete() {
    ...
    setModal(null);
    setTimeout(() => showToast(`ลบ "${title}" แล้ว`), 100);
  }
  ...
  return (
    <div className="mx-auto max-w-6xl px-6 py-12">
      ...
      <p className="mt-8 text-center font-mono text-[10px] text-stone-300">
