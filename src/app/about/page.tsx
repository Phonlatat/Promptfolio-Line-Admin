      ...
      <section className="border-t border-stone-200 bg-stone-900 px-6 py-24 text-center">
        <FadeUp>
          ...
          <div className="flex flex-col items-center gap-3 sm:flex-row sm:justify-center">
            ...
            <button
              disabled
              className="inline-flex items-center gap-2 rounded-lg border border-stone-800 px-6 py-3 text-sm font-medium text-stone-600 cursor-not-allowed opacity-50"
              title="Coming soon"
            >
